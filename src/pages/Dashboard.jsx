...
function Dashboard() {
  ...
  console.log('Pending Invites:', invitations?.length ?? 0);
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Here&apos;s what&apos;s happening with your groups</p>
        </div>
        ...
        {summaryCards.map((card) => (
          <div key={card.label} className="relative overflow-hidden rounded-2xl p-5 glass-card">
            ...
            <div className="relative">
              ...
              <p className={`text-xl font-bold !text-[#1F2937] dark:!text-white ${card.isMoney ? "font-money" : ""}`}>{card.value}</p>
            </div>
          </div>
        ))}
      </div>
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold !text-[#1F2937] dark:!text-white">Your Groups</h2>
        ...
        {!loading && !error && totalGroups === 0 && (
          <div className="text-center py-16 px-4">
            ...
            <h3 className="text-base font-semibold !text-[#1F2937] dark:!text-white mb-2">No groups yet</h3>
