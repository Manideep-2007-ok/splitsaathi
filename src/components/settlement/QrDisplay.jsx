...
function QrDisplay({ upiId, payeeName, amount, transactionNote }) {
  const qrValue = buildUpiQrString({
    upiId,
    payeeName,
    amount,
    transactionNote,
    ...
    <div className="space-y-4 text-center">
      ...
      <div className="space-y-1">
        <p className="text-sm text-[var(--text-secondary)]">
          Pay{" "}
          <span className="font-bold font-[JetBrains_Mono] text-[var(--text-primary)]">
